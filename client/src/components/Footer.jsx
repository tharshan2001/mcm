      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pb-12 border-b border-stone-200 mb-12">
          <div className="mb-6 md:mb-0 text-center md:text-left">
            <h3 className="text-2xl font-serif text-[#FFC107] mb-2">Join the Loom & Craft Community</h3>
          ...
          <div className="flex w-full md:w-auto">
            ...
            />
            <button className="ml-4 flex items-center text-xs font-bold uppercase tracking-widest text-[#ffa110]900 hover:text-[#ffa110]700 transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Brand Story */}
          <div>
            <span className="text-xl font-serif font-bold text-[#FFC107] tracking-tighter mb-6 block">
            ...
            <div className="flex space-x-5 text-stone-500">
              <Instagram size={20} className="cursor-pointer hover:text-[#ffa110]800 transition-colors" />
              <Facebook size={20} className="cursor-pointer hover:text-[#ffa110]800 transition-colors" />
              <Twitter size={20} className="cursor-pointer hover:text-[#ffa110]800 transition-colors" />
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-stone-600 font-light">
              <li><a href="#" className="hover:text-[#ffa110]800 transition-colors">Silk Sarees</a></li>
              <li><a href="#" className="hover:text-[#ffa110]800 transition-colors">Cotton Handlooms</a></li>
              <li><a href="#" className="hover:text-[#ffa110]800 transition-colors">Home Linens</a></li>
              <li><a href="#" className="hover:text-[#ffa110]800 transition-colors">Seasonal Edit</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-stone-600 font-light">
              <li><a href="#" className="hover:text-[#ffa110]800 transition-colors">Shipping Policy</a></li>
              <li><a href="#" className="hover:text-[#ffa110]800 transition-colors">Returns & Exchanges</a></li>
              <li><a href="#" className="hover:text-[#ffa110]800 transition-colors">Track Your Order</a></li>
              <li><a href="#" className="hover:text-[#ffa110]800 transition-colors">Wholesale Inquiry</a></li>
            </ul>
          </div>
