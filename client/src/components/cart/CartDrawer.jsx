    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-6 border-b border-stone-200 bg-white">
          ...
          <button
            onClick={onClose}
            className="p-2 text-stone-400 hover:text-[#5C4033]800 hover:bg-amber-50 rounded-full transition-colors"
          >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8">
          {loading ? (
            ...
            <div className="h-full flex flex-col items-center justify-center text-stone-500 space-y-4">
              ...
              <button
                onClick={onClose}
                className="text-xs font-bold uppercase tracking-widest text-[#5C4033]800 border-b border-amber-800 pb-1"
              >
                Continue Shopping
              </button>
            </div>
                    ...
                    <div className="flex justify-between items-end mt-4">
                      <div className="flex items-center border border-stone-200 bg-white">
                        <button
                          ...
                          className="p-2 text-stone-500 hover:text-[#5C4033]800 transition-colors"
                        >
                          <Minus size={14} />
                        </button>
