    ...
    <>
      <form onSubmit={handlePayment} className="space-y-5">
        ...
        <button
          ...
          className="w-full py-3 bg-[#5C4033] text-white font-medium rounded-lg hover:bg-[#5C4033] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {status === 'processing' ? (
            <>
