...
const OrderDetail = () => {
  ...
  return (
    <div className="p-10 space-y-6">
      <button
        onClick={() => navigate(-1)}
        className="flex items-center gap-2 text-[#5C4033]800 text-xs font-bold uppercase tracking-widest border-b border-amber-800 hover:opacity-70 transition-opacity"
      >
        <ArrowLeft size={14} />
        Back to Orders
      </button>
