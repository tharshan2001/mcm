          ...
          return (
            <div key={item.id} className="bg-stone-50 rounded-lg p-4 group">
                ...
                {isOwner && (
                  <div className="flex items-center gap-1 ml-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      ...
                      className="p-1 text-stone-400 hover:text-[#5C4033]700 transition-colors"
                      title="Edit"
                    >
                      <Edit2 size={14} />
                    </button>
              ...
              <div className="flex gap-0.5 mb-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <Star key={i} size={12} className={i <= item.rating ? "fill-amber-400 text-[#5C4033]400" : "text-stone-200"} />
                ))}
              </div>
