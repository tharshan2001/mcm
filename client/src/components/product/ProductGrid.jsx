        ...
        >
          ...
          <div className="relative aspect-[4/5] overflow-hidden bg-stone-100 mb-5 rounded-sm">
            ...
            <div className="absolute inset-x-0 bottom-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out flex gap-2">
              ...
              <button 
                className="bg-white/90 backdrop-blur-sm p-3 text-stone-700 hover:text-[#5C4033]800 transition-colors shadow-lg"
          ...
          <div className="space-y-1">
            ...
            <h3 className="text-lg font-serif text-stone-800 leading-snug group-hover:text-[#5C4033]900 transition-colors">
              {product.name}
            </h3>
            ...
            <div className="pt-2 flex items-center gap-2">
              <div className="flex gap-0.5">
                {[...Array(5)].map((_, i) => (
                  <div key={i} className="w-1.5 h-1.5 rounded-full bg-stone-200 group-hover:bg-[#5C4033]200 transition-colors" />
                ))}
              </div>
