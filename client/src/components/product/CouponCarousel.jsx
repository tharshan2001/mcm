      ...
      <div className="bg-gradient-to-r from-[#5C4033]/60 to-[#5C4033]/70 rounded-xl mx-2 sm:mx-4 w-full max-w-xl">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2.5 sm:py-3">
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            <Gift size={12} className="text-[#5C4033]300" />
            <span className="text-[10px] uppercase tracking-widest text-[#5C4033]200/80">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {coupons.length > 1 && (
              <button
                onClick={prevSlide}
                className="p-1 text-[#5C4033]200/60 hover:text-white transition-colors hidden sm:flex"
              >
                <ChevronLeft size={16} />
              </button>
            )}
                ...
                >
                  ...
                  >
                    {copiedCode === currentCoupon.code ? (
                      ...
                      <>
                        <Tag size={11} className="text-[#5C4033]300" />
          ...
          <div className="flex items-center justify-center gap-4 mt-1.5">
            ...
            <p className="text-[10px] text-[#5C4033]200/60">
