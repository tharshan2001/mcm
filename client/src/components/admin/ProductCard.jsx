  ...
  return (
    <tr ref={ref} className={`group border-b border-stone-100 transition-colors hover:bg-[#FCF9F6] ${product.archived ? 'bg-stone-50/50' : 'bg-white'}`}>
      ...
      <td className="px-4 py-4">
        <span className="text-[9px] font-bold uppercase tracking-[0.15em] text-[#5C4033]800 bg-amber-50 px-2 py-1 rounded-sm">
      ...
      <td className="py-4 pl-4 pr-6 text-right">
        <div className="flex justify-end items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          <button 
            ...
            className="flex flex-col items-center p-2 text-stone-400 hover:text-[#5C4033]700 hover:bg-white rounded-full transition-all" 
