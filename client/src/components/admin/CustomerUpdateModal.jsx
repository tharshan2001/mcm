        ...
        <div className="p-6">
          ...
          {fetching ? (
            <div className="flex justify-center py-8">
              <Loader2 className="animate-spin text-[#5C4033]700" size={32} />
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 px-4 py-2 bg-[#5C4033] text-white rounded-lg hover:bg-[#5C4033] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                >
