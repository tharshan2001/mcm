        ...
        <div className="bg-white border border-stone-100 shadow-sm p-6 md:p-8">
          ...
          <div className="mt-6 flex justify-end pt-4 border-t border-stone-50">
            <button
              ...
              disabled={loading}
              className="bg-[#5C4033] text-white px-8 py-3 text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-[#5C4033] transition-all disabled:opacity-50 flex items-center gap-2"
            >
              {loading ? (
                <>
