    ...
    <div className="bg-[#fffaeb] min-h-screen">
      ...
      >
        ...
        <div className={`relative z-10 text-center px-4 max-w-3xl transition-all duration-1000 ${
          ...
          <span className="text-[#ffa110]300 text-xs font-bold uppercase tracking-[0.4em] mb-6 block">Our Heritage</span>
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif text-white leading-tight mb-6">
            Slow Craft for a <br /> <span className="italic text-[#ffa110]200">Fast World</span>
          </h1>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div className={`space-y-8 transition-all duration-1000 ${
            ...
            <div>
              <span className="text-[#ffa110]700 text-xs font-bold uppercase tracking-[0.3em] mb-4 block">Our Philosophy</span>
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${
            ...
            <div className="absolute -bottom-6 -left-6 md:-bottom-8 md:-left-8 bg-white p-6 md:p-8 shadow-xl max-w-xs border-l-4 border-amber-700">
              <Sparkles className="text-[#ffa110]600 mb-3" size={24} />
              ...
              <p className="text-xs font-bold uppercase tracking-widest mt-4 text-[#ffa110]700">— Master Weaver</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section 
        ref={statsRef} 
        data-section="stats"
        className="bg-[#FFC107] py-16 md:py-20"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            {stats.map((stat, idx) => (
              ...
              >
                <div className="text-3xl md:text-5xl font-serif text-[#ffa110]300 mb-2">{stat.value}</div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transition-all duration-700 ${
            ...
            <span className="text-[#ffa110]400 text-xs font-bold uppercase tracking-[0.3em] mb-4 block">What We Stand For</span>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif">Our <span className="italic text-[#ffa110]200">Core Values</span></h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {values.map((value, idx) => (
              ...
              >
                <div className="w-16 h-16 mx-auto mb-6 flex items-center justify-center rounded-full bg-amber-600/20 text-[#ffa110]400 group-hover:bg-[#ffa110]600 group-hover:text-white transition-all duration-300">
                  {value.icon}
                </div>
      ...
      >
        <div className={`text-center mb-16 transition-all duration-700 ${
          ...
          <span className="text-[#ffa110]700 text-xs font-bold uppercase tracking-[0.3em] mb-4 block">The Craft</span>
          <h2 className="text-3xl md:text-4xl font-serif text-[#FFC107]">
          ...
          {process.map((item, index) => (
            ...
            >
              <div className="flex-shrink-0 w-16 md:w-20">
                <span className="text-3xl md:text-4xl font-serif text-[#ffa110]300">{item.step}</span>
              </div>
              <div className="pt-2">
      ...
      >
        ...
        <div className={`relative z-10 max-w-3xl mx-auto text-center px-4 transition-all duration-1000 ${
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-white mb-6">
            Own a Piece of <span className="italic text-[#ffa110]200">History</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-amber-700 text-white text-sm font-semibold uppercase tracking-wider hover:bg-[#ffa110]600 transition-all"
            >
              Explore Collection
