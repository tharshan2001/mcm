          ...
          {categories.map((category, idx) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-4 md:p-6">
                <h3 className="text-white text-lg md:text-xl font-serif mb-1 group-hover:text-[#5C4033]300 transition-colors">
                  {category.name}
                </h3>
                ...
                <div className="mt-3 opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                  <span className="text-[#5C4033]300 text-xs uppercase tracking-widest border-b border-amber-300 pb-1">
                    Explore
                  </span>
                </div>
              </div>
